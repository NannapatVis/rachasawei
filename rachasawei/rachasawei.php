...
<body>
  ...
  <nav class="navbar bg-dark navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="rachasawei.php">
              <font size="4.5">HOME</font>
            </a>
          </li>
      ...
      <li class="container-fluid">
        ...
        <?php if (isset($_SESSION['user_id'])) { ?>
          <a class="navbar-brand" href="####">
            ...
            <a class="navbar-brand" href="http://localhost/rachasawei/rachasawei.php"> <!--logout.php-->
              ...
              <a class="navbar-brand" href="cart.php">
                ...
                <font size="4.5">CART (<?php echo count($_SESSION['cart']) ?>)</font>
              </a>
  ...
  <div class="album py-5 bg-light">
    <div class="container">
      <div class="row">
        ...
        ?>
          <div class="col-md-4">
            <div class="card mb-3 box-shadow" while="300" height="300">
              <a href="./menu.php?id=<?= $result['id'] ?>">
                ...
                <center><img src="<?= $result['img'] ?>" while="300" height="300" class="resize" /></center>
                <div class="clear"></div>
                <div></div><br />
                ...
                <div class="card-body">
                  <center>
                    <h5 class="card-text"><b>
                        <font size="5.5" color="#000000"><?= $result['name_food'] ?></font>
                      </b></h5>
                    <b>
                      <font size="4.5" color="#000000"><?= $result['price'] ?> ฿</font>
                    </b><br><br>
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">View</button>

                      <a href="add_to_cart.php?id=<?php echo $result['id']; ?>" button type="button" class="btn btn-sm btn-outline-secondary">Add to Cart</a>
  ...
  <footer class="py-4 bg-dark">
    <center>
      <svg xmlns="http://www.w3.org/2000/svg" height="1.75em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
        <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" />
      </svg>

      <svg xmlns="http://www.w3.org/2000/svg" height="1.75em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
      ...
      <br><br>
      <div class="container">
        <p class="m-0 text-center text-white">Good Dessrets is The Foundation of Happiness</p>
      </div>
    </center>
  </footer>
